...
dependencies {
    mache("io.papermc:mache:26.1.2+build.2")
...
paperweight {
    ...
    val fork = forks.register("pewpew") {
        upstream.patchDir("paperServer") {
            upstreamPath = "paper-server"
            excludes = setOf("src/minecraft", "patches", "build.gradle.kts")
            patchesDir = rootDirectory.dir("pewpew-server/paper-patches")
...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "Pewpew",
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "Pewpew",
            "Specification-Version" to project.version,
            "Specification-Vendor" to "Paper Team",
            "Brand-Id" to "pewpew:pewpew",
            "Brand-Name" to "Pewpew",
